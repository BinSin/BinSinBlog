...
### D3 Selections
d3.select : selects only the first matching element
d3.selectAll : selects all matching element
...
array.lastIndexOf(5); // 마지막으로 요소가 5인 인텍스 위치 리턴 -> 6
```
